namespace MVC5HW1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資訊統計Repository Get客戶資訊統計Repository()
		{
			var repository = new 客戶資訊統計Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資訊統計Repository Get客戶資訊統計Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資訊統計Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
